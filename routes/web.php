...
Route::middleware('auth')->group(function () {
    ...
    // --- FAQ’s ---
    // FAQ-overzicht voor iedereen die is ingelogd
    Route::get('/faqs', [FaqController::class, 'index'])->name('faqs.index');

    // Vraag indienen (publiek binnen auth, je eigen filtering gebeurt in de controller of blade)
    Route::get('/faqs/ask',  [FaqController::class, 'ask'])->name('faqs.ask');
    Route::post('/faqs/ask', [FaqController::class, 'submit'])->name('faqs.submit');

    // CRUD op FAQ’s (voor superadmin via de blade)
